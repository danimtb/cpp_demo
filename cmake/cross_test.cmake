...
set(REMOTE_HOST jetson@192.168.1.99)
set(REMOTE_WORKING_DIR "/home/jetson/dev-remote/tmp")
...
foreach(LIBDIR ${CONAN_RUNTIME_LIB_DIRS})
  ...
  string(REPLACE "$<$<CONFIG:Release>" "" LIBDIR "${LIBDIR}")
...
set(CMAKE_TEST_LAUNCHER ${REMOTE_RUN_SCRIPT})
